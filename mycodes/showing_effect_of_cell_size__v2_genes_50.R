...
# Plot
{
  ...
  if(!file.exists(file.path(".", "model", "top_50"))){
    dir.create(file.path(".", "model", "top_50"))
  }
  ...
  ggsave(file.path(".", "model", "top_50", "bias_correction.png"), plot = p_save, dpi = "retina", width = 40, height = 30, units = "cm")
  ...
  ggsave(file.path(".", "model", "top_50", "bias_correction_v2.png"), plot = p_save, dpi = "retina", width = 60, height = 50, units = "cm")
  ...
  p_save <- ggplot(data = out_pd[!type %in% set ], aes(x = est, y = `Houseman DNAm-based`, color = type, shape = type)) + 
    ...
    theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
          ...
          legend.position = c(0.85, 0.10),
          legend.title = element_text(face="bold"))
  ggsave(file.path(".", "model", "top_50", "bias_correction_v3_Darmanis_ref.png"), plot = p_save, dpi = "retina", width = 40, height = 30, units = "cm")
  ...
  p_save <- ggplot(data = out_pd[type %in% set], aes(x = est, y = `Houseman DNAm-based`, color = type, shape = type)) + 
    ...
    theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
          ...
          legend.position = c(0.85, 0.10),
          legend.title = element_text(face="bold"))
  ggsave(file.path(".", "model", "top_50", "bias_correction_v3_nac_ref.png"), plot = p_save, dpi = "retina", width = 40, height = 30, units = "cm")
  ...
  sapply(1:n_distinct(out_pd$type), function(i){
    p_save <- ggplot(data = out_pd[type == t[i], ], aes(x = est, y = `Houseman DNAm-based`, color = type)) + 
      ...
      theme(plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
            ...
            legend.title = element_text(face="bold"))
    ggsave(file.path(".", "model", "top_50", paste0("bias_correction_type", i, ".png")), plot = p_save, dpi = "retina", width = 30, height = 20, units = "cm")
  })
  ...
  p_save <- ggplot(data = out_pd_v3, aes(x = est, y = `Houseman DNAm-based`, color = type, shape = type)) + 
    ...
    theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
          ...
          legend.title = element_text(face="bold"), 
          legend.text = element_text(size = 12, face="bold"))
  ggsave(file.path(".", "model", "top_50", "bias_correction_new_darmanis_ref.png"), plot = p_save, dpi = "retina", width = 60, height = 50, units = "cm")
  ...
  p_save <- ggplot(data = out_pd_v4, aes(x = est, y = `Houseman DNAm-based`, color = type, shape = type)) + 
    ...
    theme(plot.title = element_text(size = 14, face = "bold", hjust = 0.5),
          ...
          legend.title = element_text(face="bold"), 
          legend.text = element_text(size = 12, face="bold"))
  ggsave(file.path(".", "model", "top_50", "bias_correction_new_NAc_ref.png"), plot = p_save, dpi = "retina", width = 60, height = 50, units = "cm")
...
fwrite(rbind(mytable_nac, mytable_dar), 
       file = file.path("cell_type_data", "top_50.txt"))
